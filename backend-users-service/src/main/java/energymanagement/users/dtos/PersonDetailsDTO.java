package energymanagement.users.dtos;

import energymanagement.users.dtos.validators.annotation.AgeLimit;
...
public class PersonDetailsDTO {
    ...
    @AgeLimit(limit = 18)// shouldnt this be 17? cuz 18 is not allowed
    private int age;
