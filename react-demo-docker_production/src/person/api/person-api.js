...
function deletePerson(id, callback) {
  let request = new Request(
    `${HOST.backend_api}${endpoint.person}/${id}`, // Use template literals for cleaner string concatenation
    {
      method: "DELETE", // Correct the method name to uppercase
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      },
...
export { getPersons, getPersonById, postPerson, deletePerson };
